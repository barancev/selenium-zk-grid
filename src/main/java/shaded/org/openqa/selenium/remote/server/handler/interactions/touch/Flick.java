...
package shaded.org.openqa.selenium.remote.server.handler.interactions.touch;
...
public class Flick extends shaded.org.openqa.selenium.remote.server.handler.WebElementHandler<Void> implements shaded.org.openqa.selenium.remote.server.JsonParametersAware {
  ...
  public Flick(shaded.org.openqa.selenium.remote.server.Session session) {
    super(session);
  }
