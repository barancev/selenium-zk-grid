...
public class ClickInSession extends shaded.org.openqa.selenium.remote.server.handler.WebDriverHandler<Void> implements JsonParametersAware {
  volatile boolean leftMouseButton = true;

  public ClickInSession(shaded.org.openqa.selenium.remote.server.Session session) {
    super(session);
  }
