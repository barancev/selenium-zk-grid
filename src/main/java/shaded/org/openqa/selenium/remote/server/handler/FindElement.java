...
public class FindElement extends WebDriverHandler<Map<String, String>> implements shaded.org.openqa.selenium.remote.server.JsonParametersAware {
  private static Logger log = Logger.getLogger(FindElement.class.getName());
  private volatile By by;

  public FindElement(shaded.org.openqa.selenium.remote.server.Session session) {
    super(session);
  }
