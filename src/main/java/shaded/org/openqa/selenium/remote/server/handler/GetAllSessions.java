...
public class GetAllSessions implements RestishHandler<List<GetAllSessions.SessionInfo>> {
  ...
  private volatile shaded.org.openqa.selenium.remote.server.DriverSessions allSessions;

  public GetAllSessions(shaded.org.openqa.selenium.remote.server.DriverSessions allSession) {
