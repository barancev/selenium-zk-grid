...
public class UploadFile extends WebDriverHandler<String> implements shaded.org.openqa.selenium.remote.server.JsonParametersAware {

  private String file;

  public UploadFile(shaded.org.openqa.selenium.remote.server.Session session) {
    super(session);
  }
