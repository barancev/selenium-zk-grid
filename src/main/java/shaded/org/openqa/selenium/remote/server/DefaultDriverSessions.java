...
public class DefaultDriverSessions implements DriverSessions {
  ...
  private final shaded.org.openqa.selenium.remote.server.DriverFactory factory;

  private final Map<SessionId, shaded.org.openqa.selenium.remote.server.Session> sessionIdToDriver =
      new ConcurrentHashMap<SessionId, shaded.org.openqa.selenium.remote.server.Session>();
  ...
  public DefaultDriverSessions() {
    this(Platform.getCurrent(), new shaded.org.openqa.selenium.remote.server.DefaultDriverFactory());
  }

  public DefaultDriverSessions(
      shaded.org.openqa.selenium.remote.server.DriverFactory factory, Map<Capabilities, Class<? extends WebDriver>> drivers) {
  ...
  protected DefaultDriverSessions(Platform runningOn, shaded.org.openqa.selenium.remote.server.DriverFactory factory) {
    this.factory = factory;
  ...
  private void registerDriverProviders(Platform current) {
    for (shaded.org.openqa.selenium.remote.server.DriverProvider provider : ServiceLoader.load(shaded.org.openqa.selenium.remote.server.DriverProvider.class)) {
  ...
  public SessionId newSession(Capabilities desiredCapabilities) throws Exception {
    ...
    shaded.org.openqa.selenium.remote.server.Session session = DefaultSession.createSession(factory, sessionId, desiredCapabilities);
  ...
  public shaded.org.openqa.selenium.remote.server.Session get(SessionId sessionId) {
    return sessionIdToDriver.get(sessionId);
  }

  public void deleteSession(SessionId sessionId) {
    final shaded.org.openqa.selenium.remote.server.Session removedSession = sessionIdToDriver.remove(sessionId);
