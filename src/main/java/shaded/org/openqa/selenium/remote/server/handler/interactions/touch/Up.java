...
public class Up extends shaded.org.openqa.selenium.remote.server.handler.WebElementHandler<Void> implements JsonParametersAware {
  ...
  public Up(shaded.org.openqa.selenium.remote.server.Session session) {
    super(session);
  }
