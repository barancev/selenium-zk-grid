...
public class DefaultSession implements Session {
  ...
  public static Session createSession(shaded.org.openqa.selenium.remote.server.DriverFactory factory,
  ...
  @VisibleForTesting
  public static Session createSession(shaded.org.openqa.selenium.remote.server.DriverFactory factory, TemporaryFilesystem tempFs,
                                      SessionId sessionId, Capabilities capabilities)
      throws Exception {
    return new DefaultSession(factory, tempFs, sessionId, capabilities);
  }

  private DefaultSession(final shaded.org.openqa.selenium.remote.server.DriverFactory factory, TemporaryFilesystem tempFs,
                         SessionId sessionId, final Capabilities capabilities) throws Exception {
    this.knownElements = new shaded.org.openqa.selenium.remote.server.KnownElements();
    ...
    if (!isQuietModeEnabled(browserCreator, capabilities)) {
      ...
      initialDriver.register(new shaded.org.openqa.selenium.remote.server.SnapshotScreenListener(this));
    }
...
/*    if (executor.isShutdown()){
  ...
  public shaded.org.openqa.selenium.remote.server.KnownElements getKnownElements() {
  ...
  private class BrowserCreator implements Callable<EventFiringWebDriver> {
    ...
    BrowserCreator(shaded.org.openqa.selenium.remote.server.DriverFactory factory, Capabilities capabilities) {
